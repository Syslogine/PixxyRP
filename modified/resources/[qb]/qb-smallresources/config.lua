...
Config.Discord = {
    ["IsEnabled"] = true,
    ["ApplicationId"] = '934650808505606214',
    ["IconLarge"] = 'fivem',
    ["IconLargeHoverText"] = 'www.pixxy.online',
    ["IconSmall"] = 'fivem1',
    ["IconSmallHoverText"] = 'www.fivem.net',
    ["UpdateRate"] = 60000,
    ["ShowPlayerCount"] = true,
    ["MaxPlayers"] = 48,
    ["Buttons"] = {
        {text = 'Join Pixxy!',url = 'fivem://connect/localhost:30120'},
        {text = 'Visit Pixxy Online',url = 'https://pixxy.online'}
    }
}
...
Config.MapText = "~b~Pixxy Roleplay"
...
Config.CarWash = {
    [1] = {["label"] = "Hands Free Carwash",["poly"] = {coords = vector3(174.81,-1736.77,28.87),length = 7.0,width = 8.8,heading = 359}},
    [2] = {["label"] = "Hands Free Carwash",["poly"] = {coords = vector3(25.2,-1391.98,28.91),length = 6.6,width = 8.2,heading = 0}},
    [3] = {["label"] = "Hands Free Carwash",["poly"] = {coords = vector3(-74.27,6427.72,31.02),length = 9.4,width = 8,heading = 315}},
    [4] = {["label"] = "Hands Free Carwash",["poly"] = {coords = vector3(1362.69,3591.81,34.5),length = 6.4,width = 8,heading = 21}},
    [5] = {["label"] = "Hands Free Carwash",["poly"] = {coords = vector3(-699.84,-932.68,18.59),length = 11.8,width = 5.2,heading = 0}}
}
